...
function loadAiCandidates(manifest) {
...
async function loadAiSpace(manifest) {
...
return { assetURL, readParquet, loadDetail, loadDashboard, loadAiCandidates, loadAiSpace, loadAiFigures };
})();
void (async () => {
const { loadDashboard, assetURL, loadAiCandidates, loadAiSpace, loadAiFigures } = __dashboardDataAPI;
let D;
