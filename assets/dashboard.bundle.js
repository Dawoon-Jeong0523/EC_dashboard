...
return { assetURL, readParquet, loadDetail, loadDashboard, loadAiCandidates, loadAiSpace };
})();
void (async () => {
const { loadDashboard, assetURL, loadAiCandidates, loadAiSpace } = __dashboardDataAPI;
let D;
